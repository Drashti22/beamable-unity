...
namespace Beamable.Api.Autogenerated.Realms
{
	...
	public partial interface IRealmsApi
	{
		...
		Promise<InFlightFailureResponse> GetAdminInflightFailures(string serviceName, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> serviceObjectId);
		/// <param name="gsReq">The <see cref="BatchDeleteInFlightRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="CommonResponse"/></returns>
		Promise<CommonResponse> DeleteAdminInflightFailures(BatchDeleteInFlightRequest gsReq);
	...
	public partial class RealmsApi : IRealmsApi
	{
		...
		public virtual Promise<GetGameResponse> GetGames()
		{
			...
			// make the request and return the result
			return _requester.Request<GetGameResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<GetGameResponse>);
		}
		/// <returns>A promise containing the <see cref="RealmConfigResponse"/></returns>
		public virtual Promise<RealmConfigResponse> GetConfig()
		{
			...
			// make the request and return the result
			return _requester.Request<RealmConfigResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<RealmConfigResponse>);
		}
		/// <param name="gsReq">The <see cref="RealmConfigSaveRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="CommonResponse"/></returns>
		...
		public virtual Promise<ServicePlansResponse> GetPlans()
		{
			...
			// make the request and return the result
			return _requester.Request<ServicePlansResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<ServicePlansResponse>);
		}
		/// <param name="gsReq">The <see cref="CreatePlanRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="CommonResponse"/></returns>
		...
		public virtual Promise<CustomerViewResponse> GetCustomer()
		{
			...
			// make the request and return the result
			return _requester.Request<CustomerViewResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<CustomerViewResponse>);
		}
		/// <param name="gsReq">The <see cref="NewCustomerRequest"/> instance to use for the request</param>
		/// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
		/// <returns>A promise containing the <see cref="NewCustomerResponse"/></returns>
		...
		/// <param name="serviceObjectId"></param>
		/// <returns>A promise containing the <see cref="InFlightFailureResponse"/></returns>
		public virtual Promise<InFlightFailureResponse> GetAdminInflightFailures(string serviceName, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string> serviceObjectId)
		{
			...
			// make the request and return the result
			return _requester.Request<InFlightFailureResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<InFlightFailureResponse>);
		}
		/// <param name="gsReq">The <see cref="BatchDeleteInFlightRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="CommonResponse"/></returns>
		public virtual Promise<CommonResponse> DeleteAdminInflightFailures(BatchDeleteInFlightRequest gsReq)
		{
			string gsUrl = "/basic/realms/admin/inflight/failures";
			// make the request and return the result
			return _requester.Request<CommonResponse>(Method.DELETE, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), true, this.Serialize<CommonResponse>);
		...
		public virtual Promise<LaunchMessageListResponse> GetLaunchMessage()
		{
			...
			// make the request and return the result
			return _requester.Request<LaunchMessageListResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<LaunchMessageListResponse>);
		}
		/// <param name="gsReq">The <see cref="CreateLaunchMessageRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="CommonResponse"/></returns>
		...
		public virtual Promise<CustomerResponse> GetAdminCustomer()
		{
			...
			// make the request and return the result
			return _requester.Request<CustomerResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<CustomerResponse>);
		}
		/// <param name="rootPID"></param>
		/// <returns>A promise containing the <see cref="GetGameResponse"/></returns>
		...
		public virtual Promise<PromoteRealmResponseOld> GetProjectPromote(string sourcePid, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string[]> contentManifestIds, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string[]> promotions)
		{
			...
			// make the request and return the result
			return _requester.Request<PromoteRealmResponseOld>(Method.GET, gsUrl, default(object), true, this.Serialize<PromoteRealmResponseOld>);
		}
		/// <param name="gsReq">The <see cref="PromoteRealmRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="PromoteRealmResponseOld"/></returns>
		public virtual Promise<PromoteRealmResponseOld> PostProjectPromote(PromoteRealmRequest gsReq)
		{
			string gsUrl = "/basic/realms/project/promote";
			// make the request and return the result
			return _requester.Request<PromoteRealmResponseOld>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), true, this.Serialize<PromoteRealmResponseOld>);
		}
		/// <param name="includeAuthHeader">By default, every request will include an authorization header so that the request acts on behalf of the current user. When the includeAuthHeader argument is false, the request will not include the authorization header for the current user.</param>
		/// <returns>A promise containing the <see cref="CustomersResponse"/></returns>
		...
		public virtual Promise<PromoteRealmResponse> GetPromotion(string sourcePid, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string[]> contentManifestIds, [System.Runtime.InteropServices.DefaultParameterValueAttribute(null)][System.Runtime.InteropServices.OptionalAttribute()] Beamable.Common.Content.Optional<string[]> promotions)
		{
			...
			// make the request and return the result
			return _requester.Request<PromoteRealmResponse>(Method.GET, gsUrl, default(object), true, this.Serialize<PromoteRealmResponse>);
		}
		/// <param name="gsReq">The <see cref="PromoteRealmRequest"/> instance to use for the request</param>
		/// <returns>A promise containing the <see cref="PromoteRealmResponse"/></returns>
		public virtual Promise<PromoteRealmResponse> PostPromotion(PromoteRealmRequest gsReq)
		{
			string gsUrl = "/basic/realms/promotion";
			// make the request and return the result
			return _requester.Request<PromoteRealmResponse>(Method.POST, gsUrl, Beamable.Serialization.JsonSerializable.ToJson(gsReq), true, this.Serialize<PromoteRealmResponse>);
		}
	}
}
